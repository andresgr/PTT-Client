 ...
 */
package es.umu.mvia.imsclient.impl.fileaccess;
...
public class FileAccessServiceImpl implements FileAccessService {
     ...
     * imsclient config home and carrying the specified name.
    ...
    public String getScHomeDirName()
    {
        ...
        //system properties
        String scHomeDirName = getSystemProperty(PNAME_SC_HOME_DIR_NAME);
     ...
     *
     * @param homedir the location of the imsclient home directory.
