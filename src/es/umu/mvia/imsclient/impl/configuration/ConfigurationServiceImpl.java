 ...
 */
package es.umu.mvia.imsclient.impl.configuration;
...
import org.w3c.dom.*;
import org.xml.sax.*;
import es.umu.mvia.imsclient.impl.configuration.xml.*;
import es.umu.mvia.imsclient.impl.fileaccess.FileAccessServiceImpl;
import es.umu.mvia.imsclient.service.configuration.*;
import es.umu.mvia.imsclient.service.configuration.event.*;
import es.umu.mvia.imsclient.service.fileaccess.*;
    ...
    implements ConfigurationService
{
    ...
    private static final String FILE_NAME_PROPERTY
        = "es.umu.mvia.imsclient.CONFIGURATION_FILE_NAME";

    private static final String SYS_PROPS_FILE_NAME_PROPERTY
        = "es.umu.mvia.imsclient.SYS_PROPS_FILE_NAME";
     ...
     */
    private static FileAccessService faService = new FileAccessServiceImpl();
     ...
     * <code>
     * es.umu.mvia.imsclient.PROP1=value1<br>
     * es.umu.mvia.imsclient.service.protocol.PROP1=value2
     * </code>
     * <p>
     ...
     * es.umu.mvia.imsclient.PROP1, whereas the same call with
        ...
        throws IOException, XMLException
    {
        ...
        try
        {
            ...
            if(file.length() < "<imsclient>".length()*2)
    ...
    private Document createPropertiesDocument()
    {
        if(propertiesDocument == null)
        {
            ...
            propertiesDocument.appendChild(
                propertiesDocument.createElement("imsclient"));
        }
     ...
     * imsclient.xml unless a different one is specified in the system
     * property es.umu.mvia.imsclient.PROPERTIES_FILE_NAME . The method
     ...
     * $HOME/.imsclient directory. In case it was not found there either
     * we'll look for it in all locations currently present in the $CLASSPATH.
     * In case we find it in there we will copy it to the
     * $HOME/.imsclient directory in case it was in a jar archive and
    ...
    File createConfigurationFile()
    {
        try
        {
            ...
            //name of the imsclient home directory
            String scHomeDirName = getScHomeDirName();

            //location of the imsclient home directory
            ...
            {
                logger.debug("Using config file in $HOME/.imsclient: "
                             + configFileInUserHomeDir.getCanonicalPath());
