 ...
 */
package es.umu.mvia.imsclient.impl.media.device;
    ...
    private void detectCaptureDevices() {
        ...
        try {
            dsauto = Class.forName(
                    "es.umu.mvia.imsclient.impl.media.configuration.DirectSoundAuto");
            dsauto.newInstance();
        ...
        try {
            jsauto = Class.forName(
                    "es.umu.mvia.imsclient.impl.media.configuration.JavaSoundAuto");
            jsauto.newInstance();
        ...
        try {
            auto = Class.forName(
                    "es.umu.mvia.imsclient.impl.media.configuration.VFWAuto");
        }
        catch (Exception e) {
        ...
        if (auto == null) {
            try {
                auto = Class.forName(
                        "es.umu.mvia.imsclient.impl.media.configuration.SunVideoAuto");
            }
            catch (Exception ee) {
            ...
            try {
                autoPlus = Class.forName(
                        "es.umu.mvia.imsclient.impl.media.configuration.SunVideoPlusAuto");
            }
            catch (Exception ee) {
        ...
        if (auto == null) {
            try {
                auto = Class.forName(
                        "es.umu.mvia.imsclient.impl.media.configuration.V4LAuto");
            }
            catch (Exception ee) {
