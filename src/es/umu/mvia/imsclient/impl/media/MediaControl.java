...
import es.umu.mvia.imsclient.impl.media.device.*;
...
public class MediaControl
{
    ...
    private static final String PROP_SDP_PREFERENCE
                            = "es.umu.mvia.imsclient.impl.media.sdppref";
    ...
    private static final String DEBUG_DATA_SOURCE_URL_PROPERTY_NAME
      = "es.umu.mvia.imsclient.impl.media.DEBUG_DATA_SOURCE_URL";
    ...
    {
        "es.umu.mvia.imsclient.impl.media.codec.audio.alaw.JavaEncoder",
        "es.umu.mvia.imsclient.impl.media.codec.audio.alaw.DePacketizer",
        "es.umu.mvia.imsclient.impl.media.codec.audio.alaw.Packetizer",
        "es.umu.mvia.imsclient.impl.media.codec.audio.ulaw.Packetizer",
        "es.umu.mvia.imsclient.impl.media.codec.audio.speex.JavaEncoder",
        "es.umu.mvia.imsclient.impl.media.codec.audio.speex.JavaDecoder",
        "es.umu.mvia.imsclient.impl.media.codec.audio.ilbc.JavaEncoder",
        "es.umu.mvia.imsclient.impl.media.codec.audio.ilbc.JavaDecoder"
//        "es.umu.mvia.imsclient.impl.media.codec.audio.g729.JavaDecoder",
//        "es.umu.mvia.imsclient.impl.media.codec.audio.g729.JavaEncoder",
//        "es.umu.mvia.imsclient.impl.media.codec.audio.g729.DePacketizer",
//        "es.umu.mvia.imsclient.impl.media.codec.audio.g729.Packetizer"
    };
     ...
     */
    public MediaControl(NetworkAddressManagerServiceImpl namsi)
    {
