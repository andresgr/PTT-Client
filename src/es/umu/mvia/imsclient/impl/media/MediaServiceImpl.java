...
import es.umu.mvia.imsclient.service.media.event.*;
    ...
    implements MediaService
{
     ...
     * control mapping.
     */
    private MediaControl defaultMediaControl;
     ...
     * Default constructor
     */
    public MediaServiceImpl(NetworkAddressManagerServiceImpl namsi) {

        this.networkAddressManagerServiceImpl = namsi;

        defaultMediaControl = new MediaControl(networkAddressManagerServiceImpl);
        ...
        throws MediaException
    {
        ...
        MediaControl callMediaControl = new MediaControl(networkAddressManagerServiceImpl);
