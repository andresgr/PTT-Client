...
import es.umu.mvia.imsclient.impl.protocol.sip.*;
...
public class SipSecurityManager
{
    ...
    /**
     * The Protocol Provider Service SIP Implementation
     */
     ...
     * going to serve.
     */
    public SipSecurityManager(AccountID accountID, ProtocolProviderServiceSipImpl pps)
    {
        this.accountID = accountID;
        this.sipProvider = pps;
    }
               ...
               NullPointerException
    {
        ...
        while (authHeaders.hasNext())
        {
            ...
            String storedPassword = IMSConfigurationServiceImpl.
                    getProtocolProviderFactorySipImpl().loadPassword(accountID);
            ...
            else
            {
                ...
                if (ccEntryHasSeenTran)
                {
                    ...
                    IMSConfigurationServiceImpl.
                    getProtocolProviderFactorySipImpl().storePassword(
                        accountID, null);
        ...
        ViaHeader via = (ViaHeader)reoriginatedRequest.getHeader(ViaHeader.NAME);
        via.setRPort();
        reoriginatedRequest.setHeader(via);
        ...
        throws OperationFailedException
    {
        ...
        //String qop = (qopList != null) ? "auth-int" : null;
        String nc_value = "00000001";
        String cnonce = sipProvider.getRandomHex(32);
        ...
        throws ParseException, InvalidArgumentException
    {
        ...
        newViaHeader.setBranch(ProtocolProviderServiceSipImpl.BRANCH_BEGIN +
    ...
    private CredentialsCacheEntry createCcEntryWithNewCredentials(String realm)
    {
        ...
        if( ccEntry.userCredentials != null
            && ccEntry.userCredentials.isPasswordPersistent())
                IMSConfigurationServiceImpl.getProtocolProviderFactorySipImpl().
                        storePassword(accountID,ccEntry.userCredentials.getPasswordAsString());
