              ...
              , SipListener
{
    ...
    private static final String FAIL_CALLS_ON_DEST_USER_MISMATCH
        = "es.umu.mvia.imsclient.impl.protocol.sip."
        ...
        throws OperationFailedException, ParseException
    {
        Address toAddress;
        try {
            toAddress = parseAddressStr(callee);
        }catch (ParseException pe) {
            toAddress = protocolProvider.getAddressFactory().createAddress(callee);
        }
        ...
        throws OperationFailedException
    {
        ...
        /**
         * AÑADO EL SOPORTE PARA PTT
         */
        Header supportedHeader;
        try {
            supportedHeader = protocolProvider.getHeaderFactory().createHeader("Supported", "PoC");
        ...
        throws OperationFailedException
    {
        ...
        if (destinationInetAddress != null) {
            ...
            try {
                viaHeaders = protocolProvider.getLocalViaHeaders(
                        InetAddress.getByName(((SipURI)protocolProvider.
                                ...
                                Request           invite)
    {
        ...
        try {
            ...
            ringing.setHeader(protocolProvider.getIMS_OSGi_ClientAgentHeader());
                            ...
                            Request byeRequest)
    {
        ...
        try {
            ...
            ok.setHeader(protocolProvider.getIMS_OSGi_ClientAgentHeader());
        }
        catch (ParseException ex) {
