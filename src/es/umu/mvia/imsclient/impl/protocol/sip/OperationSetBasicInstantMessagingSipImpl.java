...
import es.umu.mvia.imsclient.service.protocol.Message;
    ...
    implements OperationSetBasicInstantMessaging
{
        ...
        throws IllegalStateException, IllegalArgumentException
    {
        ...
        //Adding IMS headers
        if (sipProvider.hasRouteHeader(mes.getMethod()))
            mes.setHeader(sipProvider.getRouteHeader(mes.getMethod()));

        mes.addHeader(sipProvider.getAllowHeader());
        mes.addHeader(sipProvider.getIMS_OSGi_ClientAgentHeader());
        ...
        throws OperationFailedException
    {
        ...
        try
        {
            ...
            destinationInetAddress = sipProvider.getOutboundProxySocketAddress() != null ?
                sipProvider.getOutboundProxySocketAddress().getAddress() :
