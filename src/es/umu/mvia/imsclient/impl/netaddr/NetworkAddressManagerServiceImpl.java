 ...
 */
package es.umu.mvia.imsclient.impl.netaddr;
...
import es.umu.mvia.imsclient.impl.media.MediaServiceImpl;
import es.umu.mvia.imsclient.service.media.MediaService;
 ...
 * <br>
 * es.umu.mvia.imsclient.STUN_SERVER_ADDRESS - the address of the stun
 * server to use for NAT traversal
 * <br>
 * es.umu.mvia.imsclient.STUN_SERVER_PORT - the port of the stun server
 ...
 * <br>
 * es.umu.mvia.imsclient.common.PREFERRED_NETWORK_ADDRESS - the address
 * that the user would like to use. (If this is a valid address it will be
 * returned in getLocalhost() calls)
 * <br>
 * es.umu.mvia.imsclient.common.PREFERRED_NETWORK_INTERFACE - the network
    ...
    implements NetworkAddressManagerService,  VetoableChangeListener
{
    ...
    public static final String BIND_RETRIES_PROPERTY_NAME
        = "es.umu.mvia.imsclient.service.netaddr.BIND_RETRIES";
    ...
    public NetworkAddressManagerServiceImpl(){
        ...
        System.setProperty("java.net.preferIPv4Stack", "true");
         ...
         mediaService = new MediaServiceImpl(this);
    ...
    private DatagramSocket initRandomPortSocket()
    {
        ...
        String bindRetriesStr =
            configurationService.getString(BIND_RETRIES_PROPERTY_NAME);
