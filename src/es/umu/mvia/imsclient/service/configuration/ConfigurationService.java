 ...
 */
package es.umu.mvia.imsclient.service.configuration;
...
public interface ConfigurationService
{
    ...
    public static final String PNAME_SC_HOME_DIR_NAME
        = "es.umu.mvia.imsclient.SC_HOME_DIR_NAME";
    ...
    public static final String PNAME_SC_HOME_DIR_LOCATION
        = "es.umu.mvia.imsclient.SC_HOME_DIR_LOCATION";
     ...
     * es.umu.mvia.imsclient.PROPERTIES_FILE_NAME, and is set to
     * imsclient.xml in case the property does not contain a valid file
     * name. The location might be one of three possibile, checked in the
     * following order: <br>
     * 1. The current directory. <br>
     * 2. The imsclient directory in the user.home
     *    ($HOME/.imsclient)
     * 3. A location in the classpath (such as the imsclient jar file).
     * <p>
     * In the last case the file is copied to the imsclient configuration
