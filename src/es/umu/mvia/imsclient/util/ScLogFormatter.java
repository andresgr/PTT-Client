 ...
 */
package es.umu.mvia.imsclient.util;
    ...
    extends java.util.logging.Formatter
{
    ...
    public synchronized String format(LogRecord record)
    {
        ...
        if(loggerName.startsWith("es.umu.mvia.imsclient."))
        {
            sb.append(loggerName.substring("es.umu.mvia.imsclient."
                                           .length()));
        }
        else
    ...
    private int inferCaller(LogRecord record)
    {
        ...
        while (ix < stack.length)
        {
            ...
            if (cname.equals("es.umu.mvia.imsclient.util.Logger"))
            {
                break;
            }
            ix++;
